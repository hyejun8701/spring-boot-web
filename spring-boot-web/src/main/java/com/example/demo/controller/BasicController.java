...
public class BasicController {
	 ...
	 * public Todo postBasic(@PathVariable String todoTitle) {
	 ...
	 */
	  ...
	  public ResponseEntity<TodoResource> geth(@RequestParam(value = "todoTitle") String todoTitle) {
		  ...
		  todoResource.add(ControllerLinkBuilder.linkTo(ControllerLinkBuilder.methodOn(this.getClass()).geth(todoTitle)).withSelfRel());
